    ...
    <Box>
      ...
      <Container>
        ...
        >
          ...
          <Typography align="left">
            <b>Camera Data:</b> Any photos or videos captured using the App’s
            camera feature are processed solely for the purposes of providing
            the service (e.g., photo uploads, video sharing). We do not store or
            transmit this data to our servers unless explicitly stated.
            <Typography>
              <b>Gallery Data:</b> When you grant access to your photo gallery,
              the App can only access the specific files you select. The App
              will not browse your gallery or collect data from unselected
              files.
            </Typography>
          </Typography>
          <Typography
